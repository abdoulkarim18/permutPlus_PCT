                    ...
                    <div class="fiche-person">
                        ...
                        <div class="fiche-main">
                            <div class="detail">
                                <div class="form-group">
                                    <div class="label">Nom et Prénoms</div>
                                    <div class="input">{{ $user->nom }} {{ $user->prenoms }}</div>
                                </div>
                                <div class="form-group">
                                    <div class="label">Nom de jeune fille</div>
                                    <div class="input">{{ $user->nom_fille? $user->nom_fille:'' }}</div>
                                </div>
                                <div class="form-group">
                                    <div class="label">Date de naissance</div>
                                    <div class="input">{{ $user->datenaiss? $user->datenaiss:'' }}</div>
                                </div>
                                <div class="form-group">
                                    <div class="label">Matricule</div>
                                    <div class="input">{{ $user->matricule }}</div>
                                </div>
                                <div class="form-group">
                                    <div class="label">Emploi</div>
                                    <div class="input">{{ $user->emploi? $user->emploi:'' }}</div>
                                </div>
                                <div class="form-group">
                                    <div class="label">Direction Régionale</div>
                                    <div class="input">{{ $customRequest->odren }}</div>
                                </div>
                                <div class="form-group">
                                    <div class="label">Inspection d'enseignement Primaire</div>
                                    <div class="input">{{ $customRequest->oiep }}</div>
                                </div>
                                <div class="form-group">
                                    <div class="label">Etablissement ou Service</div>
                                    <div class="input">{{ $customRequest->oschool }}</div>
                                </div>

                                <div class="form-group">
                                    <div class="label">Fonction exercée</div>
                                    <div class="input">{{ $user->fonction? $user->fonction:'' }}</div>
                                </div>
                            </div>
                            <div class="signature">Signature de l'interessé</div>
                        </div>
