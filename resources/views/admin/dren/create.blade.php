...
<div>
    <div id="formAct">
        ...
        <div id="form" class="form-border">
            <form action="{{ route('admin-drens.store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
    ...
    <div id="fichier_excel" style="display:none">
        <div class="text-right mb-3">
            <a href="{{ route('admin-drens.create') }}" class="btn btn-outline-info btn-lg" id="blockForm" style="display:none">Revenir au formulaire</a>
         </div>
        <div class="form-border">
            <form action="{{ route('importExcelDren') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                    <label for="import_file" class="mb-3">Le fichier Excel à importer (L'entête (DREN) ne doit pas figuré pas dans le fichier à importer !)</label>
                    <div class="mb-4">
